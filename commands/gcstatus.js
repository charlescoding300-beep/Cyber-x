...
module.exports = {
    ...
    run: async ({
        ...
        if (!isOwner && !isAdmin) {                                         return sock.sendMessage(
                from,
                {
                    text:
        ...
        if (url) {
            ...
            try {
                ...
                let imageUrl =
                    ...
                    $('meta[property="og:image:url"]').attr('content') ||                                                                           $('meta[property="og:image:secure_url"]').attr('content') ||
                ...
                if (imageUrl) {
                    ...
                    try {
                        ...
                        console.log(
                            '[ZEN X GCSTATUS] Preview image:',                              imageUrl
                        )
                ...
                // ==============================
                                                                                if (previewImage) {                                                                                                                 await sock.sendMessage(                                             from,
                        {                                                                   image: previewImage,                                            caption,                                                        groupStatus: true                                           }
                    )

                } else {

                    // If no preview image exists,
                    // still post the link as a REAL                                // Group Status.
        ...
        if (!quotedMsg) {
            ...
            return sock.sendMessage(
                from,
                {
                    text:                                                               '❌ *Reply to a text, image, video, audio or website link.*\n\n' +
                        'Example:\n' +
            ...
            if (
                ...
                quotedMsg.extendedTextMessage?.text
                    ...
                    text:                                                               quotedMsg.conversation ||
                        quotedMsg.extendedTextMessage.text,                         groupStatus: true
                }
